...
window.open("http://sdccollegebpet.in/admin/Modules/api/markscard/index.php?reg_no="+$(this).attr('data-id'), "PopupWindow", "width=1000,height=800,scrollbars=yes,resizable=no");
