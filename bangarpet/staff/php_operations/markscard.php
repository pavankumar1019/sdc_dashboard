...
if($_POST['type']=="loaddata"){
    ...
    FROM ".$tbl_admission."
    LEFT JOIN ".$class_test_marks." ON ".$tbl_admission.".RollNo = ".$class_test_marks.".roll  WHERE ".$tbl_admission.".Class=".$_SESSION['class_id']." AND ".$class_test_marks.".test_id=". $_SESSION['test_name']."    
    ";
