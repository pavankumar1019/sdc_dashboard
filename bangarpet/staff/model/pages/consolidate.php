                            ...
                            <div class="modal-body">
                                <form method="post" id="markscardform">
                                    <div class="form-row">
                                        ...
                                        <input type="text" class="form-control p-lg-2"  name="l1" id="l1 mark" required>

                                        </div>
                                        <div class="form-group col-md-2">
                                        <label for="numberonly">L2 MARKS</label>
                                        <input type="text" class="form-control p-lg-2" name="l2" id="l2 mark"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="10" required>

                                        </div>
                                        <div class="form-group col-md-2">
                                        <label for="numberonly">S1 MARKS</label>
                                        <input type="text" class="form-control p-lg-2" name="s1" id="s1 mark"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="10" required>

                                        </div>
                                        <div class="form-group col-md-2">
                                        <label for="numberonly">S2 MARKS</label>
                                        <input type="text" class="form-control p-lg-2" name="s2" id="s2 mark"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="10" required>

                                        </div>
                                        <div class="form-group col-md-2">
                                        <label for="numberonly">S3 MARKS</label>
                                        <input type="text" class="form-control p-lg-2" name="s3" id="s3 mark"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="10" required>

                                        </div>
                                        <div class="form-group col-md-2">
                                        <label for="numberonly">S4 MARKS</label>
                                        <input type="text" class="form-control p-lg-2" name="s4" id="s4 mark"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="10" required>

                                        </div>
                                        <div class="form-group col-md-4">
                                        <label for="numberonly">TOTAL MARKS</label>
                                        <input type="text" class="form-control p-lg-2" name="gt" id="gt mark"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="10" required>
