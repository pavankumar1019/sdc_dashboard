    ...
    <nav class="pcoded-navbar">
        <div class="navbar-wrapper">
            ...
            <div class="navbar-content scroll-div">
                ...
                <?php
                if($_SESSION['role_staff']=="ct"){
                    echo '<li data-username="Sample Page" class="nav-item"><a href="./dashboard.php?page=exportConsolidate"  class="nav-link"><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Download Consolidate</span></a></li>';
                }
                ?>
                ...
                ?>
                        <?php
                if($_SESSION['id']==32 || $_SESSION['id']==21){
                    echo '<li data-username="Sample Page" class="nav-item"><a href="./dashboard.php?page=examcoordinate" class="nav-link"><span class="pcoded-micon"><i class="feather icon-sidebar"></i></span><span class="pcoded-mtext">Exam Co-ordinate</span></a></li>
                    ';
                }
                ?>
