...
// $('body').append('' +
//     '<div class="fixed-button">' + '<a href="tel:7483737698" target="_blank" class="btn btn-md btn-primary">' + '<i class="fa fa-cogs" aria-hidden="true"></i> Contact Developer' +
//     '</a> ' + '</div>' + '');
// var $window = $(window);
...
$('#newadmissionsubmit').on('submit', function(event){
