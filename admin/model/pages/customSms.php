                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control" style="height:100px" id="exampleFormControlTextarea1">Dear <input
                            ...
                            &nbsp;<input style="background:#ccffff;border:none;font-weight:bold;width:100%;" type="tel"
                                name="" id="">
                            SDC <input style="background:#ccffff;border:none;font-weight:bold;" type="tel" name=""
                                id="">
                        </div>
                    </div>
                </form>
