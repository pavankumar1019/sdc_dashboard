...
<form>
  ...
  <div class="form-group">
    ...
    <textarea id="number" class="form-control" id="exampleFormControlSelect2" rows="5" pattern="/^[0-9][0-9\s]*$/" style="background:#404040;border:none;font-weight:bold;color:white; font-family: 'Lucida Console', 'Courier New', monospace;'" ></textarea>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="form-control" style="height:100px" id="exampleFormControlTextarea1" >Dear <input style="background:#ccffff;border:none;font-weight:bold;" type="tel" name="" id=""> 
 &nbsp;<input style="background:#ccffff;border:none;font-weight:bold;width:100%;" type="tel" name="" id="">
